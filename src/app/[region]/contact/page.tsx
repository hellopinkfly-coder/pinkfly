/**
 * Regional /contact — /india/contact, /dubai/contact, /usa/contact
 *
...
export async function generateMetadata({ params }: Params) {
  ...
  return buildMetadata({
    ...
    path: "/contact",
    ...(await getPageSeo("contact", pageSeo.contact)),
  });
}
...
export default async function Page({ params }: Params) {
  ...
  return <ContactPage region={await getRegionContent(getRegion(slug))} />;
}
