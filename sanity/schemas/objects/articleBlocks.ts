...
/**
 * Blocks an editor can place between the paragraphs of a Knowledge Base
 * entry: a video, or a file to download. Images use the shared `figure`
 * object, so an inline picture behaves exactly like every other image on the
 * site — upload or external URL, alt text, optional caption chip.
 *
